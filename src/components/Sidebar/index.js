...
const Sidebar = () => (
    <div className="nav-bar">
        ...
        <nav>
            <NavLink exact="true" activeclassname="active" href="home" >
                <FontAwesomeIcon icon={faHome} color="#ffffff" />
            </NavLink>
            <NavLink exact="true" className="about-link" href="about" >
                <FontAwesomeIcon icon={faUser} color="#ffffff" />
            </NavLink>
            <NavLink exact="true" className="contact-link" href="/contact" >
